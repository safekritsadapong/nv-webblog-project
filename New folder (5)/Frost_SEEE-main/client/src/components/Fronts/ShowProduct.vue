    ...
    <div class="component-wrapper container">
        ...
        <div v-if="product" >
            ...
            <div class="product-wrapper" v-if="product != null">
                <h1>{{ product.title }}</h1>
                <p><strong>Category: </strong>: <a href="#" v-on:click.prevent="navigateTo(`/front-products?search=${product.category}`)">{{product.category }}</a></p>
            ...
            <comment-comp v-bind:productid="product.id" v-bind:user="user"></comment-comp>
